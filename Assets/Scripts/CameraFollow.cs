...
public class CameraFollow : MonoBehaviour {
	...
	//public GenerarObjeto scriptgenerar;
	...
	void Start () {
		...
		//scriptgenerar = GameObject.Find("Punto1Salida").GetComponent<GenerarObjeto>();
		//scriptgenerar.enabled = false;
	}
