...
public class CameraFollowLibre : MonoBehaviour {
	...
	public float separacionveloz_y = 0f;
	...
	void Update () {
		...
		if (playe == false) {
			...
			float posY = Mathf.SmoothDamp (transform.position.y, velozity.transform.position.y + separacionveloz_y , ref velocity.y, smoothTimeY);
